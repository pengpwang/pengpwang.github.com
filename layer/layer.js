...
!function (a, b) {
    ...
    var c, d, e = {
        ...
        , msgsuccess: function (a, d, g) {
            ...
            }, i && !e.config.skin ? {skin: k + " layui-layer-hui-success", shift: l} : function () {
                return d = d || {}, (-1 === d.icon || d.icon === b && !e.config.skin) && (d.skin = k + " " + (d.skin || "layui-layer-hui-success")), d
            }()))
        }
        , msgerror: function (a, d, g) {
            var i = "function" == typeof d, j = e.config.skin, k = (j ? j + " " + j + "-msg" : "") || "layui-layer-msg-error", l = h.anim.length - 1;
            return i && (g = d), f.open(c.extend({
                content: a,
                time: 3e3,
                shade: !1,
                ...
                return d = d || {}, (-1 === d.icon || d.icon === b && !e.config.skin) && (d.skin = k + " " + (d.skin || "layui-layer-hui-error")), d
            }()))
        }
